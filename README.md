🚖 Quick Cab - How to Run the Project Locally
Follow these steps to set up and run the Quick Cab project on your local machine.
...
git clone https://github.com/your-username/quick-cab.git
...
POST /api/captain/register → Captain register
POST /api/ride/book → Book a ride
GET /api/maps/route → Get route (requires API key)

If any route is protected, add a token to the Authorization header in this format:
